export class routes {
  ...
  public static get addCenter(): string {
    return this.baseUrl + '/center/add-center';
  }
  public static get addSpecalist(): string {
    return this.baseUrl + '/center/add-specalist';
  }
  public static get centerList(): string {
    return this.baseUrl + '/center/center-list';
  }
  public static get editCenter(): string {
    return this.baseUrl + '/center/edit-center';
  }
  ...
  public static get home():string {
    return this.baseUrl+'/home/home-page';
  }
  public static get SearchDoctor():string {
    return this.baseUrl+'/home/doctor-search';
  }
}
