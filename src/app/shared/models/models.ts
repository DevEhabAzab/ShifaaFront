...
export interface CenterView{
  ...
  centerDesc:string;
  centerLocationLat:string;
  centerLocationLon:string;
  centerLogo:string;
  centerMobile:string;
  centerName:string;
  centerPhone:string;
...
export interface searchDocotr{
  ...
  centerName:any;
  centerDesc:any;
  centerLocationLon:any;
  centerLocationLat:any;
  centerAddress:any;
  centerLogo:any;
  centerType:any;
  centerPhone:any;
